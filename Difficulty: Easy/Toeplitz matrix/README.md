<h2><a href="https://www.geeksforgeeks.org/problems/toeplitz-matrix/1?page=10&difficulty=Easy&status=unsolved&sortBy=submissions">Toeplitz matrix</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">A <strong>Toeplitz matrix</strong> (also known as a diagonal-constant matrix) is a matrix in which every descending diagonal from left to right contains the same element.</span></p>
