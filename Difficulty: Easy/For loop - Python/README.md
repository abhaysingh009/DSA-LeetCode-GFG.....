<h2><a href="https://www.geeksforgeeks.org/problems/for-loop-python/1?page=7&difficulty=Easy&status=unsolved&sortBy=submissions">For loop - Python</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Writing for loop in Python is a tad different from C++ and Java counterparts. In this question, we'll learn to print table by using the for loop.</span></p>
