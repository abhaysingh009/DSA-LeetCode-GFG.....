<h2><a href="https://www.geeksforgeeks.org/problems/even-odd/1?page=14&difficulty=Easy&status=unsolved&sortBy=submissions">Even Odd</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;"><em>We've learnt about operators and other basics of CPP. Now, it's time to take another leap and learn how to use control structures that helps us choose flow of any code.</em></span></p>
